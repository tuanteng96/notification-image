...
function Home() {
  ...
  const onExportImage = async () => {
    ...
    axios
      .post(`/api/v3/file?cmd=base64`, bodyFormData, {
    ...
    >
      <div className="w-full md:w-[300px] md:min-w-[300px] lg:w-[400px] lg:min-w-[400px] p-5 bg-white h-full md:overflow-auto order-last md:order-first">
        <div className="md:hidden">
          <button
            type="button"
            className="bg-primary text-white h-[38px] px-4 rounded flex items-center justify-center w-full mb-5 relative disabled:opacity-75"
